...
def load_image(image_numpy):
    # load image
    # image_pil = Image.open(image_path).convert("RGB")  # load image
    image_pil = Image.fromarray(image_numpy.astype('uint8')).convert('RGB')
    transform = T.Compose(
        [
...
def get_grounding_output(image_pil, model_type, checkpoint_path, caption, box_threshold, text_threshold, with_logits=True, cpu_only=False):
